...
int main()
{
	...
	while (!exit){
		...
		while (!exit2){
			...
			switch (selection){
			case 1:
				switch (Menu("Клиент,Добавить клиента с клавиатуры,Изменить данные о клиенте,Удалить запись о клиенте,Вывести ФИО клиента на экран,Назад,", 6)){
				case 1:
				...
				break;
			case 2:
				switch (Menu("Информация,Добавить информацию с клавиатуры,Изменить информацию,Удалить информацию,Вывести информацию на экран,Назад,", 6)){
				case 1:
		...
		//			currentShop.db->infoes->;
				...
				break;
			case 3:
				switch (Menu("Учет,Добавить учет с клавиатуры,Изменить запись об учете,Удалить запись об учете,Вывести записи об учете  на экран,Назад,", 6)){
				case 1:
			...
			case 4:
				switch (Menu("Связь информации и клиенты,Добавить связь с клавиатуры,Удалить запись о связи,Вывести записи о состояниях на экран,Назад,", 5)){
				case 1:
				...
				break;
			case 5:
				switch (Menu("Связь клиента и учета,Добавить операции с клавиатуры,Удалить запись об операции,Вывести записи об операциях на экран,Назад,", 5)){
				case 1:
		...
		//
			...
			case 8:
				currentShop.db->SaveChanges();
				break;

			case 9:
				cout << "Введите путь до папки с файлами: ";
				getline(cin, *currentShop.FolderAddress);
				currentShop.db = new Database(*currentShop.FolderAddress);
				break;

			default:
				exit2 = true;
				cout << "Сохранить сделанные изменения? (1 - да, 2 - нет) : ";
				int i;
				cin >> i;
				cin.get(c);
				if (i == 1){
